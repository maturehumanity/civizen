...
**Slice 1 Education-to-Contribution (2026-08-13):** `/contribute/professional` is live. Organizer review shows applicant identity via `list_opportunity_applicant_identities` (no copied profile fields). Optional quality/impact scores are in evaluation detail. Local RLS harness is skipped without loopback Supabase credentials. LANGUAGE_PACK_VERSION 144.
