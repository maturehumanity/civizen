...
export const permissionMetadata: PermissionMetadata[] = [
  ...
  {
    permission: 'updates.test',
    section: 'administration',
    page: 'admin',
    titleKey: 'admin.permissionLabels.updates.test',
    descriptionKey: 'admin.permissionDescriptions.updates.test',
  },
  {
  ...
  },
  {
    ...
    section: 'administration',
    page: 'adminPermissions',
    titleKey: 'admin.permissionLabels.finance.view',
    descriptionKey: 'admin.permissionDescriptions.finance.view',
  },
  {
    permission: 'finance.edit',
    section: 'administration',
    page: 'adminPermissions',
    titleKey: 'admin.permissionLabels.finance.edit',
    descriptionKey: 'admin.permissionDescriptions.finance.edit',
  },
  {
    permission: 'finance.approve',
    section: 'administration',
    page: 'adminPermissions',
    titleKey: 'admin.permissionLabels.finance.approve',
    descriptionKey: 'admin.permissionDescriptions.finance.approve',
  },
  {
    permission: 'finance.publish',
    section: 'administration',
    page: 'adminPermissions',
    titleKey: 'admin.permissionLabels.finance.publish',
    descriptionKey: 'admin.permissionDescriptions.finance.publish',
  },
  {
    permission: 'finance.admin',
    section: 'administration',
    page: 'adminPermissions',
    titleKey: 'admin.permissionLabels.finance.admin',
