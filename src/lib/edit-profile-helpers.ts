...
export const LAYOUT_REGION_LABELS = {
  ...
  editProfileLocationGroup: 'Current location',
  ...
  wcFrontIdLineCompact: 'Civizen Member ID',
...
export const LEGACY_LAYOUT_STORAGE_PREFIX = 'civizen-edit-profile-layout-v1';
export const EDIT_PROFILE_LAYOUT_SCHEMA_VERSION = 3;
export const EDIT_PROFILE_LAYOUT_SCHEMA_KEY_PREFIX = 'civizen-edit-profile-layout-schema-v1';
export const BUILD_STORAGE_EVENT = 'civizen-build-storage-updated';
...
export function normalizeProfileDraft(values: {
  ...
  return {
    ...
    region_code: values.regionCode.trim().toUpperCase() || null,
  };
}
