export const baseTranslations = {
  ...
  "onboarding": {
    ...
    "statusLiveMarket": "Prototype marketplace using non-purchasable demonstration credits",
    ...
    "productMarketDescription": "Browse listings and start an agreement from a listing. Luma is a non-transferable prototype credit for demonstration — it does not settle real transactions.",
