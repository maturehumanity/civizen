export const baseTranslations = {
  ...
  "settings": {
    ...
    "adminFundingOverviewStatus": "Detailed Budget currently centers Validation Program v0.2 (~$530M base exact $530.2M; prior $524M and v0.1 $446M historical). The five-year first-wave working base (~$37.5B) stays in Program plan — not as one ordinary ledger row.",
    ...
    "adminFundingEconomicsFppNoteValidation": "~$530M validation funding (v0.2 Base exact $530.2M) = restricted and currently excluded. Prior v0.2 working total ~$524M and v0.1 ~$446M are historical superseded estimates.",
