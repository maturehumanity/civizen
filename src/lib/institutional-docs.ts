import currentLegalStatus from '../../docs/02-moderated/policies/institutional/current-legal-status-notice.md?raw';
import institutionalIdentity from '../../docs/02-moderated/policies/institutional/institutional-identity-and-relationship.md?raw';
import missionIndependence from '../../docs/02-moderated/policies/institutional/mission-and-independence-charter.md?raw';
import governanceOversight from '../../docs/02-moderated/policies/institutional/governance-and-human-oversight.md?raw';
import fundingIntegrity from '../../docs/02-moderated/policies/institutional/funding-and-financial-integrity.md?raw';
import investorNotice from '../../docs/02-moderated/policies/institutional/investor-interest-non-offering-notice.md?raw';
import contributorPolicy from '../../docs/02-moderated/policies/institutional/contributor-participation-and-recognition.md?raw';
import openSourceIp from '../../docs/02-moderated/policies/institutional/open-source-ip-brand-stewardship.md?raw';
import transparencyStandard from '../../docs/02-moderated/policies/institutional/transparency-and-accountability-standard.md?raw';
import partnerships from '../../docs/02-moderated/policies/institutional/international-partnerships-and-chapters.md?raw';
import worldCitizenship from '../../docs/02-moderated/policies/institutional/world-citizenship-and-civic-status-notice.md?raw';
import planetaryCitizenshipPathway from '../../docs/02-moderated/policies/foundation/recognized-planetary-citizenship-pathway.md?raw';
import aiAuthority from '../../docs/02-moderated/policies/institutional/ai-advisory-and-human-authority.md?raw';
import communityCharter from '../../docs/02-moderated/policies/governance/civizen-community-governance-charter.md?raw';
