  ...
  "chunks": [
    {
      ...
      "text": "Home status=implemented. Signed-in home feed with Score snapshot, Governance shortcut, post composer, and post actions Like · Comment · Repost · Publish to…. Open Home from the bottom nav. Share a post from the composer. On any post: Like, Comment (discussion under the post), Repost (plain or with thoughts into your own feed), or Publish to… (external networks when you are the author on the official Civizen org account). Repost keeps a link to the original — it does not copy the text. Routes: /.",
      "status": "implemented",
      "priority": 3,
      "kind": "capability"
    },
    ...
    },
    {
      ...
      "path": "docs/04-operations/dev/matter-collaboration.md",
      "text": "## Lifecycle vs action state Matter lifecycle: `draft` · `submitted` · `active` · `closed`. User-facing status is **derived** (waiting for response, clarification needed, waiting for initiator, response overdue, addressed, automatically closed, reopened, …).",
      "status": "implemented",
      "priority": 6,
      "kind": "doc"
    },
    ...
    },
    {
      ...
      "path": "docs/04-operations/dev/matter-collaboration.md",
      "text": "## Phase 1 surfaces - Contribute lane **Questions, Issues & Ideas** - Queues: Needs Your Action · My Matters · Participating · Organization - Matter create, detail (current action, description, conversation, formal actions, activity) - Formal actions, comments with replies, optional evidence URL/file - Reminders, overdue, auto-close, reopen",
      "status": "implemented",
      "priority": 6,
      "kind": "doc"
    },
