...
export function MarketListingCard({
  ...
  const canStartAgreement = Boolean(buyerProfileId && !isSeller && inStock);
        ...
        <>
          ...
          >
            <Link
              ...
              data-build-key={`marketListingContact-${listing.id}`}
              data-build-label="Contact seller"
            >
              {t('market.contactButton')}
            </Link>
          </Button>
        </>
      ) : null}
