...
const THEME_STORAGE_KEY = 'civizen-theme-v1';
const LEGACY_THEME_STORAGE_KEYS = ['theme'];
const THEME_COOKIE_KEY = 'civizen-theme';
...
export function ThemeStorageSync() {
  ...
  // One-time hydrate/migrate from cookie or legacy keys — never re-apply on later theme changes.
  useEffect(() => {
