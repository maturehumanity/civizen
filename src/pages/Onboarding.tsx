    ...
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative px-6 py-6 pb-28 sm:px-8 sm:pb-12">
        ...
        >
          ...
          <MotionSection reducedMotion={reducedMotion} delay={0.12}>
            <div className="rounded-[1.75rem] border border-primary/20 bg-gradient-to-br from-primary/8 via-card/40 to-transparent p-5 sm:p-6">
              <h2 className={onboardingSectionTitleClass}>{t('onboarding.longTermTitle')}</h2>
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                {t('onboarding.longTermDescription')}
              </p>
            </div>
          </MotionSection>
          ...
          <MotionSection reducedMotion={reducedMotion} delay={0.18}>
            <fieldset className="rounded-[1.75rem] border border-destructive/15 bg-destructive/5 px-4 pb-4 pt-1 sm:px-5 sm:pb-5">
              <legend className="ml-1 px-1.5 text-sm font-semibold uppercase tracking-[0.18em] text-destructive/80">
              ...
              <div className="flex flex-col gap-2">
                {harmGroups.map((group) => (
                  <p key={group.titleKey} className="text-xs leading-relaxed text-muted-foreground">
                    <span className="font-semibold uppercase tracking-wide text-destructive/70">
                      {t(group.titleKey)}
                    </span>{' '}
