...
- `docs/02-moderated/policies/institutional/world-citizenship-and-civic-status-notice.md`
- `docs/03-governance/community-readiness-and-program-availability-framework.md`
