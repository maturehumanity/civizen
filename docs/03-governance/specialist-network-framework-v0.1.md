...
Civizen should provide a structured network of Specialists who help World Citizens in three service modes:
...
Civizen should support domain families and concrete specialist roles within each family.
...
The Specialist Network should align with existing Civizen role and profession controls:
