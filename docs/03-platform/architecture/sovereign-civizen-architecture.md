---
title: Sovereign Civizen Architecture
status: historical
canonical: true
---

# Sovereign Civizen Architecture

## Overview

Sovereign Civizen is a fully self-sustaining, peer-to-peer platform where:
...
export const ENVIRONMENTS = {
  ...
  staging: {
    name: 'staging',
    p2pNetwork: 'staging.civizen.local',
    ipfsGateway: 'http://staging-ipfs.civizen.local:5001',
    featureFlags: {
      STAGING_ONLY: true,
      PROTOCOL_UPGRADES: false,
    },
...
Sovereign Civizen is a **fully decentralized, self-sustaining platform** where:
