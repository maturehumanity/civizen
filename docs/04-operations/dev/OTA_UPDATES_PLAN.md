...
- Native app is distributed via APK download from `https://civizen.world/downloads/*`.
- Update prompt currently checks `https://civizen.world/updates/android.js` for full APK updates.
...
```json
{
  ...
  "bundlePath": "/updates/bundles/civizen-web-20260412-web.3.zip",
  "bundleUrl": "https://civizen.world/updates/bundles/civizen-web-20260412-web.3.zip",
  "bundleSha256": "<hex>",
  "bundleSize": 18453210,
  "minNative": {
    "version": "0.1.4",
...
- Strict host allowlist: `@@HOST_CIVIZEN_BARE@@`.
