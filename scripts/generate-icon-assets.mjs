...
const FULL_ICON_SOURCE = path.join(ROOT_DIR, 'public/brand/civizen-icon-full.svg');
// Foreground sits on dark adaptive background — use bright (dark-surface) mark.
const MARK_ICON_SOURCE = path.join(ROOT_DIR, 'public/brand/civizen-mark-dark.svg');
...
await main();
console.log('Civizen icon assets regenerated from SVG sources.');
