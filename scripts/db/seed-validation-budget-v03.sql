-- Idempotent seed: Civizen Pre-Major-Build Validation Program v0.3
-- Exact Recommended Base $634,400,000.00. Preserves v0.1/v0.2. Marks v0.2 superseded.
-- Draft, unapproved, unpublished. No commitments/receipts/allocations.
...
BEGIN
  ...
  IF v_existing IS NOT NULL THEN
    RAISE NOTICE 'Validation Budget v0.3 already exists (%); seed skipped.', v_existing;
    RETURN;
  END IF;

  SELECT id INTO v_v02_id FROM public.project_budgets
  ...
  INSERT INTO public.project_budgets (
    ...
    'USD', 1, 'draft',
    'Selected Recommended case from doc 33. Direct $489.5M + contingency $78.3M + safe-pause $66.6M = $634.4M. VAL-EX16 quote-dependent. Historical v0.1 $446M; early v0.2 $524M; v0.2 coverage $530.2M retained. Draft only.',
    false, v_v02_id
  ...
  VALUES (
    v_budget_id,
    'Seeded Validation Budget v0.3 (exact $634,400,000.00 Recommended Base)',
    '["seed","validation-budget-v0.3","base-634.4","recommended-from-doc-33"]'::jsonb,
    'Owner-selected Recommended Validation Program (doc 33). Does not create commitments, receipts, allocations, or publication.',
    NULL
  );
  ...
  INSERT INTO public.budget_expense_groups (budget_id, name, description, display_order)
  VALUES (v_budget_id, 'Explicit operating provisions', 'Workforce benefits gap, quote-dependent program insurance, treasury/tax/facilities, emergency assistance (v0.3 Recommended).', 100)
  RETURNING id INTO v_group_id;
  v_group_ids := array_append(v_group_ids, v_group_id);
  ...
  INSERT INTO public.budget_expense_groups (budget_id, name, description, display_order)
  VALUES (v_budget_id, 'Program contingency', 'Policy contingency recalculated once (~16% of Recommended direct $489.5M).', 120)
  RETURNING id INTO v_group_id;
  v_group_ids := array_append(v_group_ids, v_group_id);

  INSERT INTO public.budget_expense_groups (budget_id, name, description, display_order)
  VALUES (v_budget_id, 'Safe-pause reserve', 'Safe-pause continuity (once-recalc) plus incident response/decommissioning slice.', 130)
  RETURNING id INTO v_group_id;
  v_group_ids := array_append(v_group_ids, v_group_id);
  ...
  INSERT INTO public.budget_line_items (
    ...
    2800000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    250000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    700000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[1], 'WS-22 · Travel, fieldwork & international coordination', 'Corrected Recommended travel book (doc 33): ~450 person-trips at ~$5k loaded traveler costs plus logistics, accessible travel, equity routing, disruption. Primary EX-22. Events→VAL-EVT; insurance premiums→VAL-EX16; staff pay→WS-01.',
    'Working estimate — not published financial figures.',
    1150000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1800000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1200000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1500000000, 0, 0, 'USD', 'Months 2–19 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1800000000, 0, 0, 'USD', 'Months 1–20 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    700000000, 0, 0, 'USD', 'Months 1–20 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1600000000, 0, 0, 'USD', 'Months 4–21 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1800000000, 0, 0, 'USD', 'Months 2–21 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1100000000, 0, 0, 'USD', 'Months 3–20 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[5], 'WS-10 · Identity & credential interoperability validation', 'Identity & credential interoperability validation (doc 33): ~8–12 jurisdictions; design/interop only — not national ID issuance or population binding. Primary EX-05/EX-12.',
    'Working estimate — not published financial figures.',
    1400000000, 0, 0, 'USD', 'Months 3–20 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1400000000, 0, 0, 'USD', 'Months 4–21 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    900000000, 0, 0, 'USD', 'Months 4–21 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[5], 'WS-15 · Accessibility, localization & nondigital inclusion validation', 'Recommended Validation sample (doc 33): ~12–16 languages; indigenous/sign/nondigital patterns. Primary EX-20. NOT every language/country. Label: Accessibility, localization & nondigital inclusion validation.',
    'Working estimate — not published financial figures.',
    1800000000, 0, 0, 'USD', 'Months 3–22 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    600000000, 0, 0, 'USD', 'Months 3–22 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    400000000, 0, 0, 'USD', 'Months 4–20 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    900000000, 0, 0, 'USD', 'Months 3–22 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    500000000, 0, 0, 'USD', 'Months 4–21 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    550000000, 0, 0, 'USD', 'Months 4–21 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    450000000, 0, 0, 'USD', 'Months 4–20 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    500000000, 0, 0, 'USD', 'Months 3–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    3600000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    2400000000, 0, 0, 'USD', 'Months 6–23 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    400000000, 0, 0, 'USD', 'Months 6–23 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    1100000000, 0, 0, 'USD', 'Months 6–23 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    250000000, 0, 0, 'USD', 'Months 6–23 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    70000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    600000000, 0, 0, 'USD', 'Months 1–12 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    250000000, 0, 0, 'USD', 'Months 1–12 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[10], 'VAL-EX16 · Program insurance & liability (EX-16 · quote-dependent)', 'QUOTE-DEPENDENT planning allowance (doc 33) — NOT validated coverage. D&O, E&O, cyber, GL, EPL, travel/medical, participant, prototype, property, SIR. Bind or formal waiver required before field/multi-party prototypes.',
    'Working estimate — not published financial figures.',
    1200000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    3000000000, 0, 0, 'USD', 'Months 2–24 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    'Working estimate — not published financial figures.',
    250000000, 0, 0, 'USD', 'Months 2–24 · working estimate',
    false, 'active', 'Grants / pass-through'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[12], 'WS-24 · Program contingency (policy)', 'Primary EX-30-01. Contingency recalculated once at ~16% of Recommended direct work program ($489.5M) → $78.3M. Not insurance; not safe-pause.',
    'Working estimate — not published financial figures.',
    7830000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Core-controlled'
  );
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[13], 'WS-25 · Safe-pause & validation-program continuity reserve', 'Primary EX-30-04. Safe-pause core after once-recalc (~13.6% of $489.5M direct minus WS-25.IR). Validation wind-down/publish/archive only — not production continuity $2–4B.',
    'Working estimate — not published financial figures.',
    6160000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
  ...
  INSERT INTO public.budget_line_items (
    ...
    v_group_ids[13], 'WS-25.IR · Incident response, emergency assistance & demonstrator decommissioning', 'Incident response & demonstrator decommissioning within safe-pause group (doc 33 Recommended $5.0M).',
    'Working estimate — not published financial figures.',
    500000000, 0, 0, 'USD', 'Months 1–24 · working estimate',
    false, 'active', 'Protected reserve'
  );

  IF v_v02_id IS NOT NULL THEN
    UPDATE public.project_budgets SET lifecycle_status = 'superseded', updated_at = now()
    WHERE id = v_v02_id AND lifecycle_status = 'draft';
    RAISE NOTICE 'Marked Validation Budget v0.2 (%) as superseded.', v_v02_id;
  END IF;

  RAISE NOTICE 'Seeded Validation Budget v0.3 (%) with exact planned_minor 63440000000.', v_budget_id;
END $$;
...
BEGIN
  ...
  IF v_id IS NULL THEN
    RAISE EXCEPTION 'Validation Budget v0.3 missing after seed';
  END IF;
  ...
  FROM public.budget_line_items li JOIN public.budget_expense_groups g ON g.id = li.group_id
  WHERE g.budget_id = v_id AND li.title LIKE 'WS-24 ·%';
  SELECT COALESCE(SUM(li.planned_minor),0) INTO v_pause
  FROM public.budget_line_items li JOIN public.budget_expense_groups g ON g.id = li.group_id
  WHERE g.budget_id = v_id AND (li.title LIKE 'WS-25 ·%' OR li.title LIKE 'WS-25.IR ·%');
  v_direct := v_sum - v_cont - v_pause;
  IF v_groups <> 13 THEN RAISE EXCEPTION 'expected 13 groups, got %', v_groups; END IF;
  IF v_lines <> 53 THEN RAISE EXCEPTION 'expected 53 lines, got %', v_lines; END IF;
  IF v_sum <> 63440000000 THEN RAISE EXCEPTION 'planned_minor %, expected 63440000000', v_sum; END IF;
  IF v_direct <> 48950000000 THEN RAISE EXCEPTION 'direct %, expected 48950000000', v_direct; END IF;
  IF v_cont <> 7830000000 THEN RAISE EXCEPTION 'contingency %, expected 7830000000', v_cont; END IF;
  IF v_pause <> 6660000000 THEN RAISE EXCEPTION 'safe-pause %, expected 6660000000', v_pause; END IF;
  RAISE NOTICE 'v0.3 OK groups=% lines=% sum=% direct=% cont=% pause=%', v_groups, v_lines, v_sum, v_direct, v_cont, v_pause;
END $$;
