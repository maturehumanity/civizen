...
const bundlePath = process.argv[3] ?? '/tmp/civizen-matters-coding-fixtures.json';
...
console.log(`verify:matters-coding-detail UI OK ${baseUrl} (screenshots in ${outDir})`);
