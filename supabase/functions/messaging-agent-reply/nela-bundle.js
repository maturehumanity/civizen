...
var KNOWLEDGE_PACK = {
  "meta": {
    "appVersion": "0.1.179",
    "appReleaseId": "20260813-v0.1.179",
    "androidVersionCode": 181,
    "gitSha": "c80493d291c0dc25d8fbe902a032ccefd2e9cd80",
    "generatedAt": "2026-08-14T00:54:50.205Z",
    "sourceFingerprint": "c9717800389fcc975748f6cd9417f093a4aecef1c75c5bba2e90fd8b26140e60",
    "knowledgeFormat": 1,
    "sourceCount": 24,
    "chunkCount": 302
  },
...
function composeFromRetrieval(retrieval, query) {
...
function prepareNelaTurn(messages, options = {}) {
  ...
  const rawRetrieval = inScope ? retrieveKnowledge(searchQuery, pack, { broaden: rewritten.isVerification }) : { faq: [], capabilities: [], documents: [] };
  const retrieval = {
  ...
  if (!inScope) {
    ...
    groundedAnswer = retrieval.faq.length || retrieval.capabilities.length || retrieval.documents.length ? composeFromRetrieval(retrieval, searchQuery) : `${UNVERIFIED} I can help with related current features if you name one.`;
  } else {
